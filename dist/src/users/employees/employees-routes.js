...
router.use(employees_controllers_1.protectEmployee);
router.patch("/update-password/:id", employees_controllers_1.sameEmployee, employees_controllers_1.employeeUpdatePassword);
router
    .route("/:id")
    .get(employees_controllers_1.sameEmployee, employees_controllers_1.getEmployee)
    .delete(employees_controllers_1.sameEmployee, employees_controllers_1.deleteEmployee)
    .patch(employees_controllers_1.sameEmployee, employees_controllers_1.updateEmployee);
